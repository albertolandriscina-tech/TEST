...
export const WIDGET_DEFINITIONS: Record<DashboardWidgetType, WidgetDefinition> = {
  kpi: {
    ...
    defaultLayout: { x: 0, y: 0, w: 12, h: 4, minW: 6, minH: 4 },
  },
  cashflow: {
    type: 'cashflow',
    title: 'Flusso di cassa',
    defaultLayout: { x: 0, y: 4, w: 8, h: 10, minW: 4, minH: 6 },
  },
  'accounts-balance': {
    type: 'accounts-balance',
    title: 'Saldo conti',
    defaultLayout: { x: 8, y: 4, w: 4, h: 10, minW: 3, minH: 5 },
  },
  'networth-trend': {
    type: 'networth-trend',
    title: 'Andamento patrimonio netto',
    defaultLayout: { x: 0, y: 14, w: 6, h: 9, minW: 4, minH: 5 },
  },
  budget: {
    type: 'budget',
    title: 'Budget del mese',
    defaultLayout: { x: 6, y: 14, w: 6, h: 9, minW: 4, minH: 5 },
  },
  'category-breakdown': {
    type: 'category-breakdown',
    title: 'Spese per categoria (mese)',
    defaultLayout: { x: 0, y: 23, w: 5, h: 9, minW: 3, minH: 5 },
  },
  'recent-transactions': {
    type: 'recent-transactions',
    title: 'Ultimi movimenti',
    defaultLayout: { x: 5, y: 23, w: 7, h: 9, minW: 4, minH: 5 },
  },
};
